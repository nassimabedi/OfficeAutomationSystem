    ...
    <table class="addtable">
      ...
      <tr>                
          ...
          <td align="right" colspan="3">
              <table border="1">
              <tr><td>
              <adm-dtp ng-model='date' require options='{calType: "jalali", format: "YYYY/MM/DD", default: today,autoClose:true}' ng-required="true"></adm-dtp></td><tr>
              </table>
      ...
      <tr>
          ...
          <td ><input type="number" name="successfull_calls_num" ng-model="successfull_calls_num" min="0" required><span class="help-inline" ng-show="submitted && form.successfull_calls_num.$error.required" style="color:red;padding-right:10px">فیلد اجباری است</span></td>
          <td>تعداد تماس‌های ناموفق:*</td>
          <td><input type="number" name="unsuccessfull_calls_num" ng-model="unsuccessfull_calls_num" min="0" required><span class="help-inline" ng-show="submitted && form.unsuccessfull_calls_num.$error.required" style="color:red;padding-right:10px">فیلد اجباری است</span></td>
      </tr>
      <tr>
       ...
       <tr ng-hide="after_shift_date">
          ...
          <td>
            ...
            <div class="col-md-5 pull-right" style="padding: 30px 10px 10px 10px;">
                <p class="input-group pull-right">
                  <input type="text" class="form-control"  datepicker-popup-persian="{{format}}" name="after_shift_end_date" ng-model="after_shift_end_date" is-open="persianIsOpenAfterShiftEnd"  datepicker-options="dateOptions"
                   <span class="input-group-btn">
...
<div >
   ...
   <table class="table table-bordered table-hover table-condensed shift-services" style="width:90%; direction:rtl;">
    ...
    <tr ng-repeat="service in services">
      ...
      <td>       
        <span editable-text="service.issue_details" e-name="group" e-form="rowform" e-required>
          {{ service.issue_details || 'empty' }}
      </td>
      <td>       
        <span editable-text="service.contact_name" e-name="group" e-form="rowform" e-required>
          {{ service.contact_name || 'empty' }}
      </td>
      <!--<td>       
        <span editable-text="service.start_date" e-name="group" e-form="rowform" data-e-style="direction:ltr;" e-required>
          {{ service.start_date || 'empty' }}
      </td>
      <td>
        <span editable-text="service.end_date" e-name="group" e-form="rowform" data-e-style="direction:ltr;" data-e-ng-click="try($event)" e-required>
          {{ service.end_date || 'empty' }}
      </td> -->
      <td style="direction:ltr;">
         <adm-dtp ng-show="rowform.$visible" ng-model='service.start_date' require options='{calType: "jalali", format: "YYYY/MM/DD hh:mm", default: today,autoClose:true,}' ng-required="true"></adm-dtp>
         <span ng-show="!rowform.$visible">{{ service.start_date || '-' }}</span>
      </td>
      <td style="direction:ltr;">
         <adm-dtp ng-show="rowform.$visible" ng-model='service.end_date' require options='{calType: "jalali", format: "YYYY/MM/DD hh:mm", default: today,autoClose:true,}' ng-required="true"></adm-dtp>
         <span ng-show="!rowform.$visible">{{ service.end_date || '-' }}</span>
      </td>
