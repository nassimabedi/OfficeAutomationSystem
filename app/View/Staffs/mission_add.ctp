...
<form name="form"  ng-submit="submitForm(form.$valid)" novalidate>
	<fieldset dir="rtl">
      ...
      <tr >
          ...
          <td><input type="text" name="purpose" ng-model="purpose" required><span class="help-inline" ng-show="submitted && form.purpose.$error.required" style="color:red;padding-right:10px">لطفا فیلد محل ماموریت را وارد نمایید</span></td>
      </tr>
			<tr >
