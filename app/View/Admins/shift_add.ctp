      ...
      <tr>
          ...
          <td style="with:40%;">
            ...
            <div class="col-md-5 pull-right" style="padding: 30px 20px 10px 10px;">
                <p class="input-group pull-right">
                  <input type="text" class="form-control"  datepicker-popup-persian="{{format}}" name="exit_hour_date" ng-model="exit_hour_date" is-open="persianIsOpenExitDate"  datepicker-options="dateOptions" date-disabled="disabled(date, mode)" close-text="بسته" disabled="{{scope.isDisabled}}" />
                   <span class="input-group-btn">
          ...
          <td>
            ...
            <div class="col-md-5 pull-right" style="padding: 30px 10px 10px 10px;">
                <p class="input-group pull-right">
                  <input type="text" class="form-control"  datepicker-popup-persian="{{format}}" name="delivery_hour_date" ng-model="delivery_hour_date" is-open="persianIsOpenDeliveryDate"  datepicker-options="dateOptions" date-disabled="disabled(date, mode)" close-text="بسته" disabled="{{scope.isDisabled}}" />
                   <span class="input-group-btn">
      ...
      <tr>
       ...
       <tr>
          ...
          <td style="with:40%;">
            ...
            <div class="col-md-5 pull-right" style="padding: 30px 20px 10px 10px;">
                <p class="input-group pull-right">
                  <input type="text" class="form-control"  datepicker-popup-persian="{{format}}" name="after_shift_start_date" ng-model="after_shift_start_date" is-open="persianIsOpenAfterShiftStart"  datepicker-options="dateOptions" date-disabled="disabled(date, mode)" close-text="بسته" disabled="{{scope.isDisabled}}" />
                   <span class="input-group-btn">
          ...
          <td>
            ...
            <div class="col-md-5 pull-right" style="padding: 30px 10px 10px 10px;">
                <p class="input-group pull-right">
                  <input type="text" class="form-control"  datepicker-popup-persian="{{format}}" name="after_shift_end_date" ng-model="after_shift_end_date" is-open="persianIsOpenAfterShiftEnd"  datepicker-options="dateOptions" date-disabled="disabled(date, mode)" close-text="بسته" disabled="{{scope.isDisabled}}" />
                   <span class="input-group-btn">
