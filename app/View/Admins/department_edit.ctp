<div class="users form" dir="" ng-controller="departmentEditCrtl">
<form name="form"  ng-submit="submitForm(form.$valid)" novalidate>  
	<fieldset dir="rtl">
		<legend style="padding-bottom:1%">ویرایش دپارتمان</legend>
        <style type="text/css">
        .addtable  { 
          border-spacing: 5px;
         width:100%;
    ...
    vertical-align: middle;
	  ...
	  <input type="hidden" name="department_id"  ng-model="department_id">
