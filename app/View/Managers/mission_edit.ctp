      ...
      <tr>                
        ...
        <div class="col-md-3 pull-right" style="padding: 30px 10px 10px 10px;">
            <p class="input-group pull-right">
              <input type="text" class="form-control"  datepicker-popup-persian="{{format}}" name="date" ng-model="date" is-open="persianIsOpen"  datepicker-options="dateOptions" close-text="بسته" required value="<?=$data['Missions']['date'] ?>" />
